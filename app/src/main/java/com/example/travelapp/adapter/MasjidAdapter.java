...
import com.example.travelapp.model.ModelMap;
...
public class MasjidAdapter extends RecyclerView.Adapter<MasjidAdapter.ViewHolder>{
    ...
    private List<ModelMasjid> items;
    private GoogleMap mMap;
    private HashSet<MapView> mMapViews = new HashSet<>();

    public MasjidAdapter(List<ModelMasjid> items) {
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_masjid, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ModelMasjid data = items.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements OnMapReadyCallback {
        ...
        public ViewHolder(Context context, View itemView) {
            ...
            cvPrayList = itemView.findViewById(R.id.cvMasjid);
            mapView = itemView.findViewById(R.id.mapView);
            txtPlaceName = itemView.findViewById(R.id.txtNamaMasjid);

            mapView.onCreate(null);
            mapView.getMapAsync(this);
        }

        public void setMapLocation(ModelMap mapLocation) {
