    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.cardView:
                ...
                break;
            case R.id.cardView2:
                Intent intent1= new Intent(MainActivity.this,KulinerActivity.class);
                startActivity(intent1);
                break;
            case R.id.cardView3:
                Intent intent2= new Intent(MainActivity.this,WisataActivity.class);
                startActivity(intent2);
                break;
            case R.id.cardView4:
                Intent intent3= new Intent(MainActivity.this,MasjidActivity.class);
